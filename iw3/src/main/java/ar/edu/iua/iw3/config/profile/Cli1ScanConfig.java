...
excludeFilters = {
        ...
        //todo lo que esta dentro de esta ruta, no me lo carga (que empiece con ar.edu.iua.iw3.integration.cli2)
...
},//Paquetes por los cuales se va a hacer el escaneo de entidades
basePackageClasses = {
